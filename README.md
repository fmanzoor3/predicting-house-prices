...
3. **Run the Notebook**:
   - Open the Jupyter notebook [Predict_Property_Prices.ipynb](notebooks/Predict_Property_Prices.ipynb) and run the cells to see the analysis and model training steps.
